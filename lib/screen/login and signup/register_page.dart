...
import 'package:tunesevenui/screen/login%20and%20signup/login_page.dart';
  ...
  void SignupApi() async {
    {
      ...
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            content: Text(
              " YOUR ACCOUNT IS SUCCESSFULL CREATED WAIT A MIN.",
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            content: Text(
              "TRY AGAIN LATER ${jsonDecode(response.body)['error']}",
              style: TextStyle(color: Colors.black),
            )));
      }
    }
